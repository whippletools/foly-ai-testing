...
const API_URL = 'https://folydocs.whipple.mx/api/pages/19';
const AUTH_HEADER = 'Token XE2dmFvZIRaP9f3xmpmFcLMtffOAEFd3:U6xivewGIpgRQVEi7HMnodXFINqYToku';
const MD_PATH = path.resolve(__dirname, '../docs/flujo-catalogos-vendedores.md');

async function main() {
  const markdown = fs.readFileSync(MD_PATH, 'utf-8');

  console.log('Actualizando página 19 en BookStack...');
